# Generated by Powerlevel10k configuration wizard on 2025-04-29 at 06:05 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    exec_time_ms            # duration of the last command in ms/seconds
...
# Custom exec_time_ms prompt segment: show ms if under 1s, else show seconds
function prompt_exec_time_ms() {
  emulate -L zsh
  local ms="${P9K_COMMAND_EXECUTION_TIME_MS:-0}"
  if (( ms < 1000 )); then
    p10k segment -b 3 -f 0 -t "${ms}ms"
  else
    local sec=$((ms / 1000))
    p10k segment -b 3 -f 0 -t "${sec}s"
  fi
}
